...
export type FlowContext = { nativeProtection?: boolean; evaluationMode?: 'signal' | 'risk'; runId: string; deploymentId: string; market: string; at: number; price: number; equity: number; candles: Record<string, readonly Candle[]>; fills: readonly Fill[]; cancelledOrderIds: readonly string[] };
