...
export const AuditEventTypeSchema = z.enum([
  ...
  'execution.partially_filled_cancelled',
  'execution.partially_filled_rejected',
  'execution.filled',
  'execution.cancelled',
  'flow.skipped',
  'flow.completed',
...
export const AuditEventViewSchema = z.object({
  ...
  fill: z.object({
    ...
    originalQuantity: PositiveDecimalStringSchema.optional(),
    notionalUsd: PositiveDecimalStringSchema.optional(),
  }).strict().optional(),
