...
export function runPackaging(options: { rebuildElectron(onSpawn?: (child: SpawnedChild) => void): Promise<void>; forge(onSpawn?: (child: SpawnedChild) => void): Promise<void>; restoreHost(): Promise<void>; signalOptions?: SignalOptions }): Promise<void>;
